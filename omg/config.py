...
""" hyperparameter """
cfg.smoothness_base_weight = 0.1  # weight for smoothness cost in total cost
cfg.max_smooth_weight = 0.1
cfg.smooth_schedule_rate = 1.00

cfg.base_obstacle_weight = 0.1  # weight for obstacle cost in total cost
cfg.max_obstacle_weight = 0.1  # weight for obstacle cost in total cost
cfg.min_obstacle_weight = 0.1  # weight for obstacle cost in total cost
cfg.obs_schedule_rate = 1.00  # cost schedule boost for grasp cost weight

cfg.base_grasp_weight = 10.0  # weight for grasp cost in total cost
cfg.min_grasp_weight = 10.0
cfg.grasp_schedule_rate = 1.00  # cost schedule boost for grasp cost weight
...
cfg.top_k_collision = (
    1000  # the number of closest point to penalize for each trajectory
)
...
cfg.use_goal_grad = (
    False  # whether to include the goal gradient and cost in the cost computation
)
cfg.use_min_cost_traj = False  # use trajectory with minimum goal cost
...
cfg.tgt_pos = []
cfg.initial_ik = (
    False  # Use IK at the start of trajectory optimization (for our method)
)
